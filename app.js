...
const translations = {
  es: {
    documentTitle: "Sistema de Tickets | Help Desk",
    headerEyebrow: "IT Support Dashboard",
    headerTitle: "Sistema de Tickets Help Desk",
    headerSubtitle: "Registra, consulta y gestiona solicitudes de soporte tecnico desde el navegador.",
    ...
    noReportTickets: "No hay tickets para los filtros seleccionados.",
  ...
  en: {
    documentTitle: "Help Desk Ticket System | Help Desk",
    headerEyebrow: "IT Support Dashboard",
    headerTitle: "Help Desk Ticket System",
    headerSubtitle: "Register, view, and manage support requests from the browser.",
    ...
    noReportTickets: "No tickets found for the selected filters.",
    ...
    creatingTicketAs: "Creating ticket as:",
    authenticatedUser: "Authenticated user",
    issueDescription: "Issue description",
    issuePlaceholder: "Ex. The computer cannot connect to Wi-Fi.",
    newCase: "New case",
    supportInbox: "Support inbox",
    allTickets: "All tickets",
    registeredTickets: "registered tickets",
    ticketCounters: "Ticket counters",
    openCountLabel: "Open",
    progressCountLabel: "In progress",
    closedCountLabel: "Closed",
    statusHelp: "Users create tickets as Open.",
    ...
    progressTickets: "Tickets In Progress",
    ...
    noTicketMatches: "No tickets match the search or filters.",
...
function applyStaticLanguage() {
  ...
  reportsTotalCount.parentElement.lastChild.textContent = " tickets";
